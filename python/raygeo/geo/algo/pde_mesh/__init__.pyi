...
def build_triangle_mesh(outer: collections.abc.Sequence[types.Point], holes: collections.abc.Sequence[collections.abc.Sequence[types.Point]] = (), tool_radius: float = 0, min_angle: float = 20) -> pde_mesh.TriangleMesh:
    r"""
...
def solve_laplace(mesh: pde_mesh.TriangleMesh, max_iter: int = 1000, tolerance: float = 0.00000001) -> list[float]:
    r"""

...
def generate_ramp(part: raygeo.Part, start: tuple[float, float], end: tuple[float, float], z_start: float, z_end: float, max_ramp_angle_deg: float = 45, style: str = 'zigzag', lateral_amplitude: float = 2, state: raygeo.ops.state.State | None = None) -> raygeo.ops.assembly.result.AssemblyResult:
    r"""

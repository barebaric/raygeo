...
def generate_examples(output_dir):
    ...
    fig.tight_layout()
    path = output_dir / "line-intersections.png"
    fig.savefig(path, dpi=150)
    plt.close(fig)
    images.append(
        {
            "path": "line-intersections.png",
            "caption": (
                "Line-line intersection, segment intersection hit/miss"
            ),
        }
    )
    ...
    fig2.tight_layout()
    path2 = output_dir / "line-point-distance.png"
    fig2.savefig(path2, dpi=150)
    plt.close(fig2)
    images.append(
        {
            "path": "line-point-distance.png",
    ...
    return {
        ...
        "description": (
            "Line, segment intersection, and point-to-line distance."
        ),
        "images": images,
    }

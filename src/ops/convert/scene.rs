...
impl Accumulator {
    fn new(total_cmds: usize, is_rotary: bool) -> Self {
        Accumulator {
            is_rotary,
            pv: Vec::with_capacity(total_cmds * 6),
            pva: Vec::with_capacity(total_cmds * 8),
            tv: Vec::with_capacity(total_cmds * 6),
            zpv: Vec::with_capacity(total_cmds * 6),
            ov_pos: Vec::with_capacity(total_cmds * 6),
            ov_attrib: Vec::with_capacity(total_cmds * 8),
            pv_cum: 0,
            tv_cum: 0,
            ov_cum: 0,
            ...
            rotary_segments: Vec::with_capacity(total_cmds),

...
pub fn flatten_bezier(
    ...
    let m01 = get_midpoint_3d(a, b);
    let m12 = get_midpoint_3d(b, c);
    let m23 = get_midpoint_3d(c, d);
    let q01 = get_midpoint_3d(m01, m12);
    let q12 = get_midpoint_3d(m12, m23);
    let r = get_midpoint_3d(q01, q12);

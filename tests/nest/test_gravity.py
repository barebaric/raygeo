...
class TestFindMaxSlide:
    def test_no_slide_needed(self):
        ...
        result = find_max_slide(polys, [], sheet_bounds, sheet, "y", 0.0, 1)
        assert result == 0.0
    ...
    def test_slide_x(self):
        ...
        sheet = [(0.0, 0.0), (50.0, 0.0), (50.0, 50.0), (0.0, 50.0)]
        sheet_bounds = (0.0, 0.0, 50.0, 50.0)
        result = find_max_slide(polys, [], sheet_bounds, sheet, "x", 0.0, 1)
        assert result > 9.0
    ...
    def test_blocked_by_other(self):
        ...
        sheet = [(0.0, 0.0), (50.0, 0.0), (50.0, 50.0), (0.0, 50.0)]
        sheet_bounds = (0.0, 0.0, 50.0, 50.0)
        result = find_max_slide(polys, other, sheet_bounds, sheet, "y", 0.0, 1)
        assert result < 2.0
...
class TestApplyGravity:
    def test_single_placement_no_op(self):
        ...
        sheet = [(0.0, 0.0), (50.0, 0.0), (50.0, 50.0), (0.0, 50.0)]
        result = apply_gravity(groups, sheet, 0.0, 1)
        assert len(result) == 1
    ...
    def test_empty_groups(self):
        ...
        result = apply_gravity([], sheet, 0.0, 1)
        assert result == []

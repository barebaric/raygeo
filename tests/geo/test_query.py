...
class TestBboxesIntersect:
    def test_overlapping(self):
        bbox1 = (0, 0, 10, 10)
        bbox2 = (5, 5, 15, 15)
        assert does_rect_intersect_rect(bbox1, bbox2) is True

    def test_non_overlapping(self):
        bbox1 = (0, 0, 10, 10)
        bbox2 = (20, 20, 30, 30)
        assert does_rect_intersect_rect(bbox1, bbox2) is False
    ...
    def test_one_inside_other(self):
        ...
        bbox2 = (5, 5, 15, 15)
        assert does_rect_intersect_rect(bbox1, bbox2) is True
        assert does_rect_intersect_rect(bbox2, bbox1) is True

    def test_identical(self):
        bbox = (0, 0, 10, 10)
        assert does_rect_intersect_rect(bbox, bbox) is True
